...
<div class="flex items-center justify-between h-16 px-6 border-b border-neutral-200 dark:border-dark-border flex-shrink-0">
    ...
    <button 
        ...
        class="lg:hidden p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-600 dark:text-neutral-400"
...
<div class="p-4 border-t border-neutral-200 dark:border-dark-border flex-shrink-0">
