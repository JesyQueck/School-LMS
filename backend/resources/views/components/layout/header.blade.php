<header class="h-16 bg-white dark:bg-dark-surface border-b border-neutral-200 dark:border-dark-border flex items-center justify-between px-4 sm:px-6 lg:px-8 transition-colors duration-150 shrink-0">
    ...
    <div class="flex items-center gap-2 sm:gap-3">
        ...
        <button
            ...
            class="p-2 rounded-lg hover:bg-neutral-100 dark:hover:bg-dark-800 text-neutral-600 dark:text-neutral-400 focus-visible-ring"
        ...
        <label for="sidebar-menu-checkbox" class="lg:hidden p-2 rounded-lg hover:bg-neutral-300 dark:hover:bg-dark-700 text-neutral-600 dark:text-neutral-400 focus-visible-ring transition-colors cursor-pointer" aria-label="Open menu">
