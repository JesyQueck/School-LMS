...
<body class="min-h-screen bg-background dark:bg-dark-bg text-neutral-900 dark:text-dark-text transition-colors duration-150">
    ...
    <div class="flex h-screen overflow-hidden bg-background dark:bg-dark-bg">
        ...
        <aside
            id="sidebar"
            class="fixed inset-y-0 left-0 z-40 w-72 bg-primary-700 border-r border-white/10 shadow-xl transition-transform duration-300 ease-in-out flex flex-col -translate-x-full peer-checked:translate-x-0 lg:translate-x-0 lg:relative lg:w-72"
