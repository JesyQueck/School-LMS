...
<div class="flex flex-col items-center gap-3">
    <div class="relative flex-shrink-0">
        <div class="{{ $size }} rounded-full overflow-hidden ring-2 ring-neutral-200 dark:ring-neutral-700">
            @if ($photoUrl)
        ...
        @if ($editable)
            <div class="absolute bottom-0 right-0 flex flex-col gap-1.5">
                <form method="POST" action="{{ $formAction }}" enctype="multipart/form-data">
                    @csrf
                    <label class="inline-flex cursor-pointer items-center gap-2 rounded-lg border border-neutral-300 bg-white px-2 py-1 text-xs font-medium text-neutral-700 shadow-sm hover:bg-neutral-50 dark:border-neutral-600 dark:bg-neutral-800 dark:text-neutral-200 dark:hover:bg-neutral-700">
