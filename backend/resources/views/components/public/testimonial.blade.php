...
<div class="bg-white dark:bg-dark-surface rounded-2xl border border-neutral-200 dark:border-dark-border p-7 shadow-premium card-lift hover:shadow-premium-lg">
    ...
    <div class="flex items-center gap-3 pt-5 border-t border-neutral-100 dark:border-neutral-800">
