        ...
        <div class="lg:col-span-4">
            ...
            <x-ui.card class="mt-6">
                ...
                <div class="p-6 space-y-3">
                    ...
                    <a href="{{ route('student.timetable') }}" class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-dark-border hover:border-primary-300 dark:hover:border-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors">
                        <div class="h-8 w-8 rounded-lg bg-warning-100 dark:bg-warning-900/30 text-warning-600 dark:text-warning-400 flex items-center justify-center">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3M8 7L5 7M8 7L8 11M8 7l3-3M8 7L5 7M12 7h10a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2V9a2 2 0 012-2h7z"/></svg>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-neutral-900 dark:text-white">Timetable</p>
                            <p class="text-xs text-neutral-500 dark:text-neutral-400">Class schedule</p>
                        </div>
                    </a>
                    <a href="{{ route('student.report-cards') }}" class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-dark-border hover:border-primary-300 dark:hover:border-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors">
                        ...
                        <div>
                            ...
                            <p class="text-xs text-neutral-500 dark:text-neutral-400">View published</p>
                        </div>
                    </a>
                    <a href="{{ route('student.profile') }}" class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-dark-border hover:border-primary-300 dark:hover:border-primary-700 hover:bg-primary-50 dark:hover:bg-primary-900/10 transition-colors">
                        <div class="h-8 w-8 rounded-lg bg-success-100 dark:bg-success-900/30 text-success-600 dark:text-success-400 flex items-center justify-center">
                            <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.121 10.19A9 9 0 1116.88 5.76l1.56 1.56M15 7v6a3 3 0 11-6 0V9a3 3 0 013-3h.343M12 8.5V12m0 0v3.5M12 12h3.5"</svg>
                        </div>
                        <div>
                            <p class="text-sm font-medium text-neutral-900 dark:text-white">My Profile</p>
                            <p class="text-xs text-neutral-500 dark:text-neutral-400">Personal details</p>
                        </div>
                    </a>
                </div>
            </x-ui.card>
