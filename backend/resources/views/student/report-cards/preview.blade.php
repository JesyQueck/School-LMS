<x-layouts.app title="Report Card Preview">
    <div class="mb-6">
        <x-ui.breadcrumbs>
            ...
            <x-ui.breadcrumb-item href="/student/report-cards">Report Cards</x-ui.breadcrumb-item>
    ...
    {{--
        ...
        passed to Dompdf, what the student sees here IS what downloads.
    --}}
    <div class="rounded-lg border border-neutral-200 dark:border-dark-border overflow-hidden bg-neutral-100 dark:bg-neutral-900" style="height: 85vh;">
        <iframe
            src="{{ route('student.report-cards.render', $reportCard) }}"
    ...
    <div class="mt-4">
        <a href="{{ route('student.report-cards') }}" class="text-sm text-primary-600 dark:text-primary-400 hover:text-primary-700 dark:hover:text-primary-300">
