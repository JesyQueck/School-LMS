<x-layouts.app title="Parent Dashboard">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Track your child's progress and school activities.</p>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
        <div class="lg:col-span-8">
            <x-ui.card>
                <div class="px-6 py-4 border-b border-neutral-200 dark:border-dark-border">
                    <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">Recent Results</h3>
                </div>
                <div class="p-6">
                    <div class="space-y-4">
                        <div class="flex items-center justify-between py-3 border-b border-neutral-100 dark:border-neutral-800">
                            <div>
                                <p class="text-sm font-medium text-neutral-900 dark:text-white">Mathematics</p>
                                <p class="text-xs text-neutral-500 dark:text-neutral-400">Mid-term Exam</p>
                            </div>
                            <span class="text-sm font-medium text-success-600 dark:text-success-400">A</span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-neutral-100 dark:border-neutral-800">
                            <div>
                                <p class="text-sm font-medium text-neutral-900 dark:text-white">Science</p>
                                <p class="text-xs text-neutral-500 dark:text-neutral-400">Mid-term Exam</p>
                            </div>
                            <span class="text-sm font-medium text-success-600 dark:text-success-400">A-</span>
                        </div>
                        <div class="flex items-center justify-between py-3 border-b border-neutral-100 dark:border-neutral-800">
                            <div>
                                <p class="text-sm font-medium text-neutral-900 dark:text-white">English</p>
                                <p class="text-xs text-neutral-500 dark:text-neutral-400">Mid-term Exam</p>
                            </div>
        ...
        <div class="lg:col-span-4">
            <x-ui.card>
                <div class="px-6 py-4 border-b border-neutral-200 dark:border-dark-border">
                    <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">Fee Status</h3>
                </div>
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <span class="text-sm text-neutral-500 dark:text-neutral-400">Balance</span>
                        <span class="text-2xl font-bold text-neutral-900 dark:text-white">$250</span>
                    </div>
                    <div class="flex items-center justify-between mb-4">
                        <span class="text-sm text-neutral-500 dark:text-neutral-400">Due Date</span>
                        <span class="text-sm font-medium text-neutral-900 dark:text-white">Aug 15, 2026</span>
                    </div>
