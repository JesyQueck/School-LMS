<x-layouts.app title="Student Dashboard">
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-neutral-500 dark:text-neutral-400">Here's your academic overview.</p>
    </div>
                ...
                <div class="p-6">
                    <div class="space-y-3">
                        <div class="flex items-center gap-3">
                            ...
                            <p class="text-sm text-neutral-700 dark:text-neutral-300">Mathematics — 8:00</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="h-2 w-2 rounded-full bg-accent-500"></div>
                            <p class="text-sm text-neutral-700 dark:text-neutral-300">Physics — 10:30</p>
                        </div>
                        <div class="flex items-center gap-3">
                            <div class="h-2 w-2 rounded-full bg-success-500"></div>
                            <p class="text-sm text-neutral-700 dark:text-neutral-300">English — 1:00</p>
                        </div>
                    </div>
                </div>
            </x-ui.card>
