<x-layouts.app title="Fees">
    @php
        $breadcrumbs = [
            ...
            ['label' => $student->full_name ?? 'Child', 'href' => route('parent.children.show', $student)],
    ...
    <div class="grid grid-cols-1 gap-6">
        <x-ui.card>
            <div class="px-6 py-4 border-b border-neutral-200 dark:border-dark-border">
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-0.5">Fee obligations and payment history.</p>
            </div>
                ...
                <table class="min-w-full divide-y divide-neutral-200 dark:divide-dark-border">
                    <thead class="bg-neutral-50 dark:bg-dark-surface">
                        <tr>
                            ...
                            <th scope="col" class="px-6 py-3 text-left text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Due Date</th>
                        </tr>
                    </thead>
                    <tbody class="divide-y divide-neutral-200 dark:divide-dark-border bg-white dark:bg-dark-surface">
                        @forelse($fees as $fee)
                            ...
                            <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors">
                                ...
                                <td class="px-6 py-4 text-sm text-neutral-600 dark:text-neutral-400">{{ $fee->feeType->term->end_date ?? 'N/A' }}</td>
                            </tr>
                        @empty
                            <tr>
