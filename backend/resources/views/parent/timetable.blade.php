<x-layouts.app title="Timetable">
    ...
    <div class="mb-4">
        ...
        <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Weekly timetable for {{ $student->class->name ?? 'Unknown Class' }}</p>
    </div>

    <x-ui.card>
        <div class="p-6">
            @if($student->class && $student->class->classSubjects)
