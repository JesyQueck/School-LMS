    ...
    <x-slot:title>
        <div class="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">Configure academic sessions, terms, subjects, and class mappings.</p>
            </div>
        </div>
    </x-slot:title>
        ...
        <div class="lg:col-span-12">
            <x-ui.card>
                <div class="px-6 py-4 border-b border-neutral-200 dark:border-dark-border">
                    <h3 class="text-lg font-semibold text-neutral-900 dark:text-white">Academic Sessions</h3>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-0.5">Manage academic sessions and their terms.</p>
                </div>
                <div class="p-6">
                    <form method="POST" action="{{ route('admin.academic.sessions.store') }}" class="mb-6 p-4 bg-neutral-50 dark:bg-neutral-800/30 rounded-lg border border-neutral-200 dark:border-dark-border">
                        @csrf
