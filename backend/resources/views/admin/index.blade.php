<x-layouts.app title="Admin Dashboard">
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        ...
        <x-ui.stat-card label="Parents" :value="number_format($totalParents)" icon="user-check" />
    </div>
        ...
        <div class="lg:col-span-4 h-full">
            <x-ui.card class="h-full flex flex-col">
                ...
                <div class="p-6 flex-1">
                    <div class="grid grid-cols-[1fr_auto] gap-1 items-end text-sm mb-4">
                        <div class="pb-1 border-b border-dotted border-neutral-300 dark:border-dark-border">
                    ...
                    <div class="pt-3 border-t border-neutral-200 dark:border-dark-border">
                        <div class="flex justify-between text-sm mb-1">
                        ...
                        <div class="h-2 rounded-full bg-neutral-200 dark:bg-neutral-800 overflow-hidden">
                            <div class="h-full rounded-full bg-primary-600 dark:bg-primary-500" style="width: {{ $finance['collection_rate'] }}%"></div>
                        </div>
                    </div>
                </div>
                <div class="px-6 pb-6 grid grid-cols-3 gap-2 text-center">
                    <div class="rounded-lg bg-success-200 dark:bg-success-900/20 p-2">
                        <p class="text-lg font-bold text-white dark:text-success-300">{{ $finance['paid'] }}</p>
                        <p class="text-[10px] text-neutral-600 dark:text-neutral-400 uppercase">Paid</p>
                    </div>
                    <div class="rounded-lg bg-warning-200 dark:bg-warning-900/20 p-2">
                        <p class="text-lg font-bold text-white dark:text-warning-300">{{ $finance['partial'] }}</p>
                        <p class="text-[10px] text-neutral-600 dark:text-neutral-400 uppercase">Partial</p>
                    </div>
                    <div class="rounded-lg bg-danger-200 dark:bg-danger-900/20 p-2">
                        <p class="text-lg font-bold text-white dark:text-danger-300">{{ $finance['unpaid'] }}</p>
                        <p class="text-[10px] text-neutral-600 dark:text-neutral-400 uppercase">Unpaid</p>
                    </div>
                </div>
                <div class="px-6 pb-6">
        ...
        <div class="lg:col-span-4 h-full">
            <x-ui.card class="h-full flex flex-col">
                ...
                <div class="p-6 grid grid-cols-1 gap-3 flex-1">
                    <a href="{{ route('admin.students') }}" class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-dark-border hover:border-primary-400 dark:hover:border-primary-700 hover:bg-primary-200 dark:hover:bg-primary-900/10 transition-colors">
                        <div class="h-8 w-8 rounded-lg bg-primary-200 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300 ring-1 ring-neutral-200 dark:ring-dark-border flex items-center justify-center"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"/></svg></div>
                    ...
                    <a href="{{ route('admin.teachers') }}" class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-dark-border hover:border-primary-400 dark:hover:border-primary-700 hover:bg-primary-200 dark:hover:bg-primary-900/10 transition-colors">
                        <div class="h-8 w-8 rounded-lg bg-accent-200 dark:bg-accent-900/30 text-accent-700 dark:text-accent-300 ring-1 ring-neutral-200 dark:ring-dark-border flex items-center justify-center"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5z M12 14l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14z M12 14v7"/></svg></div>
                    ...
                    <a href="{{ route('admin.finance') }}" class="flex items-center gap-3 p-3 rounded-lg border border-neutral-200 dark:border-dark-border hover:border-primary-400 dark:hover:border-primary-700 hover:bg-primary-200 dark:hover:bg-primary-900/10 transition-colors">
                        <div class="h-8 w-8 rounded-lg bg-success-200 dark:bg-success-900/30 text-success-700 dark:text-success-300 ring-1 ring-neutral-200 dark:ring-dark-border flex items-center justify-center"><svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z"/></svg></div>
