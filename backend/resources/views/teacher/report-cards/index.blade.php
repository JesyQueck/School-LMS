            ...
            <div class="flex items-center justify-between p-4 border border-neutral-200 dark:border-dark-border rounded-lg">
                ...
                <div class="flex items-center gap-2">
                    ...
                    @elseif($reportCard && $reportCard->status === 'review')
                        <span class="text-xs px-2 py-1 rounded border bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-400 border-blue-200 dark:border-blue-800">Review</span>
                    @else
                    ...
                    @if($reportCard && $reportCard->status !== 'review' && $reportCard->status !== 'published')
